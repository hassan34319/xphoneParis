...
async function QuiSommes() {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-8xl mx-auto px-4 bg-white">
      ...
      {/* Title */}
      <h1 className="text-4xl md:text-4xl lg:text-5xl font-extrabold mb-10">Qui sommes nous ?</h1>
      ...
      {/* First Text Block */}
      <p className="text-xl md:text-2xl lg:text-3xl text-center mb-10 max-w-6xl">
      ...
      <div className="w-full max-w-4xl mb-6">
        ...
        <p className="text-xl md:text-2xl text-center mt-4 mb-10 italic">
      ...
      <div className="w-full max-w-4xl mb-14">
        ...
        <p className="text-xl md:text-2xl text-center mt-4 italic">
      ...
      <p className="text-xl md:text-2xl lg:text-3xl text-center mb-14 max-w-6xl">
      ...
      {/* Shopping and Marketplace Section */}
  ...
  <span className="text-red-500"> d’Asie</span>.
      ...
      <div className="w-full max-w-4xl space-y-14 mb-14">
        {/* <div className="text-center"> */}
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-center italic">
  ...
  <span className="text-red-500"> 10 %</span> à <span className="text-red-500">20 %</span>
      ...
      {/* Warning Message */}
      <p className="text-xl md:text-2xl lg:text-3xl text-center mb-14 max-w-6xl italic">
      ...
      <div className="w-full space-y-14">
        <div className="text-center">
          ...
          <div className="space-y-2 text-lg md:text-xl lg:text-2xl">
        ...
        <div className="text-center">
          ...
          <div className="space-y-2 text-lg md:text-xl lg:text-2xl mb-8">
