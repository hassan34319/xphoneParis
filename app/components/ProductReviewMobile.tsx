    ...
    <>
          ...
          return (
            <article key={rev._key} className="mt-10 w-11/12 block md:hidden border-t-[0.5px] border-black border-opacity-50 pt-10">
              ...
              <div className="flex flex-wrap w-full h-[20vh] space-x-4 mt-4 items-center">
                {rev.images.map((img) => {
                  return (
                    <div key={rev._key} className="h-[15vh] w-[20%] relative">
                      <Image
      ...
      {currentUser && (
        <div className="bg-gray-100 p-4 rounded mt-8 w-full  md:hidden">
          ...
          <button
            className="bg-blue-500 px-2 py-2 mr-4  text-white rounded cursor-pointer text-sm"
            onClick={handleImageUpload}
          >
            Upload Image
          </button>
          <button
            className="bg-red-500 hover:bg-red-600 text-white text-sm font-medium py-2 px-2 rounded focus:outline-none focus:bg-red-600"
